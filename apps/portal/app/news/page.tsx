  ...
  return (
    <div style={{ background: '#0A0A0A', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <div style={{ maxWidth: '440px', width: '100%', textAlign: 'center' }}>
        {/* Logo / Name */}
        <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '42px', color: '#F0EDE6', letterSpacing: '2px', marginBottom: '16px' }}>
          DANIEL CORRAL
        </h1>
        ...
        {!submitted ? (
          <>
            <p style={{ color: 'rgba(240,237,230,0.55)', fontSize: '15px', lineHeight: '1.6', marginBottom: '32px' }}>
              Recibe contenido exclusivo sobre mindset, finanzas, relaciones e identidad directamente en tu correo.
            </p>
          ...
          <div>
            ...
            <p style={{ color: 'rgba(240,237,230,0.55)', fontSize: '14px' }}>
              Revisa tu correo. Pronto recibiras contenido exclusivo.
            </p>
          </div>
        )}
      </div>
